...
Account Payable (AP) 외상매입금이라고 한다. 
...
보통 생산을 하면 step1. 투입될 것을 가져와서 투입시키고 , step2. 완성된 제품을 출고시킨다. 
...
만약 자재 재고가 없는 경우 T-COGI에서 확인 가능하고, 후행처리가 가능하다.
추가 투입을 통해 출고할 수 있고, 아얘 내역을 지워 출고를 하지 않을 수 도 있다.
